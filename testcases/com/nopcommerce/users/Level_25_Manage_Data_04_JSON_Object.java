...
public class Level_25_Manage_Data_04_JSON_Object extends BaseTest {
    @Parameters("browser")
    @BeforeClass
    public void beforeClass(String browserName) {
        ...
        System.out.println(employeeData.getPosition());
        System.out.println(employeeData.getSkillTree().get(0));
        System.out.println(employeeData.getSkillTree().get(2));

        for (int i = 0; i < employeeData.getSkillTree().size(); i++) {
            System.out.println(employeeData.getSkillTree().get(i));
        }
        System.out.println(employeeData.getAddress());
    }
