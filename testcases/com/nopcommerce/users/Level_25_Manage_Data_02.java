...
public class Level_25_Manage_Data_02 extends BaseTest {
    ...
    public void beforeClass(String browserName) {
        ...
        this.firstName = User.RegisterLogin.FIRST_NAME;
        this.lastName = User.RegisterLogin.LAST_NAME;
        this.password = User.RegisterLogin.PASSWORD;
        this.company = User.RegisterLogin.COMPANY;
        this.emailAddress = User.RegisterLogin.PREFIX_EMAIL_ADDRESS + generateRandomNumber() + User.RegisterLogin.POSTFIX_EMAIL_ADDRESS;
