...
public class GlobalConstants {
    ...
    public static final String STAGING_ADMIN_URL = "https://admin-staging.demo.nopcommerce.com/";
    public static final String LIVE_ADMIN_URL = "https://admin-live.demo.nopcommerce.com/";
